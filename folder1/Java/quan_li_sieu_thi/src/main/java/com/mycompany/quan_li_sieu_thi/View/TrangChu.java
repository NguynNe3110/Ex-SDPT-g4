...
public class TrangChu extends JFrame{
    ...
    private JPanel pannelMain = new JPanel(new BorderLayout());
    ...
    private void initToolBar(String chucVu){
        ...
        if(chucVu.equals("Admin") || chucVu.equals("Kho")){
        ...
        if(chucVu.equals("Admin") || chucVu.equals("Bán Hàng")){
    ...
    private void setClick(){
        ...
        btn_QLHoaDon.addActionListener((e) -> {
            pannelMain.removeAll();               
            pannelMain.add(new QLHoaDon());
            pannelMain.revalidate();                
            pannelMain.repaint();
        });
        ...
        //
        btn_QLDanhMuc.addActionListener((e) -> {
            pannelMain.removeAll();               
            pannelMain.add(new QLDanhMucView());
            pannelMain.revalidate();                
            pannelMain.repaint();
        });
        
        btn_QLNhanVien.addActionListener((e) -> {
            pannelMain.removeAll();               
            pannelMain.add(new QLNhanVienView());
            pannelMain.revalidate();                
            pannelMain.repaint();
        });
        ...
        btn_QLBoPhan.addActionListener((e) -> {
            pannelMain.removeAll();               
            pannelMain.add(new BoPhanView());
            pannelMain.revalidate();                
            pannelMain.repaint();
        });
        
        btn_QLNhaCungCap.addActionListener((e) -> {
            pannelMain.removeAll();               
            pannelMain.add(new QLNhaCungCap());
            pannelMain.revalidate();                
            pannelMain.repaint();
        });
    }
